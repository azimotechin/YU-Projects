...
class Trade:
    ...
    ##ADDED FOR PUBSUB COMMUNICATION WITH PORTFLIOTRADEAGREGATOR
    @classmethod
    def to_pubsub_message(self) -> str:
        return f"{self.account_id}:{self.ticker}:{self.trade_type}:{self.quantity}"