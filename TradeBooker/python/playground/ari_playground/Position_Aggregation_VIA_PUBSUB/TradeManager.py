...
REDIS_PORT = 6379
TRADE_PUBSUB_CHANNEL = "trade_channel"
...
class TradeManager:
    ...
    def write_trade(self, trade: Trade) -> bool:
        try:
            ...
            ##PUBLISHING TO PUB SUB THAT PORTFOLIO TRADE AGGREGATOR WILL LISTEN ON
            self.redis_client.publish(TRADE_PUBSUB_CHANNEL, trade.to_pubsub_message())
